...
<p className='text-[14px] font-Poppins  text-justify'>{`Your Chanakya is a Medical Education Consultancy providing a professional platform for students seeking career assistance, guidance and support. We assist students seeking admission to Medical PG and  Medical UG courses in India and Abroad. `}</p>
...
<p className='text-[14px] font-Poppins pt-5 text-justify'>{`We as a team are dedicated for exploring various study abroad options for the students, having the desire to study overseas. Your Chanakya offers something for everyone who seeks to focus on developing new skills, increase their knowledge base and keep up to date with developments within their particular areas of expertise. We are specialized in the medical education and have many universities of repute as our partners. Your Chanakya is an exclusive platform for medical aspirants taking them to their destination.`}</p>
