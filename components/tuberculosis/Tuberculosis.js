...
`}</p>
        ...
        <p className='text-[14px] font-Poppins  font-[500]'>{`There are total 81 Government Medical Colleges in India which offers this course, the Post-Graduation Pulmonary medicine seats in government colleges are approximately 344 in different states of the country. Medical colleges in Rajasthan have the maximum number of Pulmonary medicine seats i.e.42. The state-wise seat distribution of Tb& chest in government medical colleges are given in the table below.`}</p>
...
<div className='bg-[#4a1e75]  text-[#63625e] p-2 my-5 flex justify-center items-center'>
        ...
        <p className='text-[14px] font-Poppins  font-[500]'>{`Total of 95 Private Medical Colleges in India which offers MD Chest medicine course, the private Medical colleges have a total of 254 TB & Chest medicine/Pulmonary Medicine seats in different states of the country. Medical colleges in Andhra Pradesh have the maximum number of Chest medicine seats i.e. 39. State-wise TB& Chest seat availability in Private medical colleges are given below in the table.`}</p>
...
<div className='pt-10'>
        ...
        <p className='text-[14px] font-Poppins  font-[500]'>{`MD TB & CHEST DOCTORS SALARY`}</p>
