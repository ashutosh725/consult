  ...
  return (
    <div className={`bg-[url('/family-doctor-008.png')] bg-cover bg-center pt-20`}>
     <div className='container mx-auto'>
       ...
       <div className='bg-[#c9e4e8] relative lg:h-[550px] h-[590px]   lg:rounded-ss-[130px] rounded-ss-[40px] lg:rounded-ee-[130px] rounded-ee-[40px] lg:ml-44 ml-0   lg:py-[80px] w-full lg:w-[80%]'>


</div>
<div className='flex flex-col lg:flex-row justify-center items-center absolute lg:top-[-15%] top-0'>
<div className='flex lg:w-[50%] w-full flex-col justify-start   items-start gap-3 p-4'>
<h3 className='lg:text-[80px] text-[25px] font-bold text-[#005450]'>CPS / FCPS</h3>
...
<div>
<Image src={Ww} alt='' className='lg:w-[434px] w-[300px] h-[300px] lg:h-[579px] lg:rounded-ss-[130px] rounded-ss-[40px] lg:rounded-ee-[130px] rounded-ee-[40px] object-cover'/>
</div>
</div>
