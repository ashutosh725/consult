...
<p className='font-Jost text-white text-[15px]'>Nscx Education is a Medical Education Consultancy providing a professional platform for students seeking career assistance, guidance and support. We assist students seeking admission to Medical PG and  Medical UG courses in India and Abroad. </p>
...
<span className='w-[100px] h-[4px] bg-white'></span>
</div>
  <ul className='flex flex-col justify-start  items-start gap-2'>
    <li><Link href={'/'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>Home</Link></li>
    <li><Link href={'/about'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>About us</Link></li>
    <li><Link href={'/cps-fcps'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>CPS - FCPS</Link></li>
    <li><Link href={'/mbbs'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>MBBS</Link></li>
    <li><Link href={'/md-ms-in-india'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>MD - MS</Link></li>
    <li><Link href={'/contact'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>Contact us</Link></li>
  </ul>
</div>
<div className='flex flex-col justify-center items-start gap-5'>
  <div className='flex flex-col gap-1'>
  ...
  <ul className='flex flex-col justify-start  items-start gap-2'>
    <li><Link href={'/career-counselling'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>Career Counselling</Link></li>
    <li><Link href={'/'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>NEET PG Counselling</Link></li>
    <li><Link href={'/career-counselling'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>NEET UG Counselling</Link></li>
    <li><Link href={'/neet-result-2023'} className='font-Jost text-[15px] text-white hover:text-primary ease-in-out duration-200'>Neet Result 2023</Link></li>
  </ul>
</div>
      </div>
      <hr className='mt-10'/>
      <div className='flex flex-col md:flex-row justify-between items-center gap-5 py-5'>
        <div className='flex justify-center items-center gap-3'>
          <Link href={'/privacy-policy'} className='font-Jost text-white text-[15px] hover:text-primary ease-in-out duration-200'>Privacy Policy</Link>
          <p>|</p>
          <Link href={'/refund-policy'} className='font-Jost text-white text-[15px] hover:text-primary ease-in-out duration-200'>Refund Policy</Link>
          <p>|</p>
          <Link href={'/terms-conditions'} className='font-Jost text-white text-[15px] hover:text-primary ease-in-out duration-200'>{`Terms & Conditions`}</Link>
        </div>
       <p className='font-Jost text-[15px] text-white'>{`Copyright © 2024 Ashutosh. All Rights Reserved.`}</p>
      </div>
    </div>
    </div>
  )
