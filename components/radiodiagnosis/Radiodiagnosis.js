...
<div className='bg-[#4a1e75]  text-[#63625e] p-2 my-5 flex justify-center items-center'>
            <p className='text-[18px] font-Poppins text-[#ffda00] font-[500]'>{`MD RADIOLOGY SEATS IN PRIVATE COLLEGES`}</p>

        </div>
        <p className='lg:text-[14px] text-[12px] font-Poppins  font-[500]'>{`There are total 141 Private Medical Colleges in India which offers the MD Radiodiagnosis course, the private medical colleges have a total of 773 Post Graduation MD Radiodiagnosis seats in different states of the country. Private medical colleges in Karnataka have the maximum number of MD Radiodiagnosis seats 181. The total number of available seats for MD Radiology in private medical colleges is given in the table below.`}</p>
...
<div className='pt-10'>
        <div className='bg-[#4a1e75]  text-[#63625e] p-2 my-5 flex justify-center items-center'>
            <p className='text-[18px] font-Poppins text-[#ffda00] font-[500]'>{`MD RADIOLOGY FEES`}</p>

        </div>
        <p className='lg:text-[14px] text-[12px] font-Poppins  font-[500]'>{`The MD Radiology Fees for state private colleges starts from 20 Lakhs to maximum 75 Lakhs per annum.
The MD Radiology Fees in deemed universities vary from college to college. It starts minimum 20 Lakhs to Maximum 65 Lakhs per annum.
The MD Radiology Fees for all India quota and state quota govt. seats start from 50k to 1.5 Lakh per annum.`}</p>
<p className='lg:text-[14px] text-[12px] font-Poppins  font-[700]'>{`*To Know college wise fee, cutoff in different categories kindly reach us.`}</p>
        ...
        <div className='bg-[#4a1e75]  text-[#63625e] p-2 mt-10 mb-5 flex justify-center items-center'>
            <p className='text-[18px] font-Poppins text-[#ffda00] font-[500]'>{`SALARY OF RADIOLOGIST`}</p>
