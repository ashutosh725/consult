...
<button className='bg-[#000000] rounded-full tracking-wide px-6 py-3 text-white text-[20px] font-medium'>Know More</button>
            ...
            <div className='lg:w-[50%] w-full'>
                ...
                <div className='flex justify-center items-center my-5'>
<button className='bg-[#f1c503] rounded-full tracking-wide px-6 py-3 text-black text-[20px] shadow-lg font-medium'>Unlock now</button>
</div>
            </div>
            <div className='lg:w-[25%] w-full'>
                <div>
                ...
                <div className='flex justify-center items-center my-5'>
<button className='bg-black rounded-full tracking-wide px-6 py-3 text-white text-[20px] shadow-lg font-medium'>Submit</button>
        </div>
                </div>
            </div>
        </div>
