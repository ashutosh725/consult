  ...
  return (
    <div className={` lg:py-20 py-10 `}>
     ...
     <div className="lg:w-[50%] w-full bg-[#4a1e75]  flex flex-col justify-center items-center gap-5 p-6 lg:pl-20">
      ...
      <h3 className="text-[#ffda00] font-Jost md:text-[36px] text-[25px]">MD MS IN INDIA</h3>
      ...
      <Link href={'/md-ms-in-india'} className="text-[#ffda00]  text-[15px] font-Poppins font-[500] underline">Learn More</Link>
     </div>
      <div className="lg:w-[50%] w-full bg-[#ffda00] flex flex-col justify-center items-center gap-5 p-6  lg:pr-20">
        <div>
          <Image src={C1} alt="" className="w-[150px] h-[150px] object-cover rounded-full" />
        </div>
        <h3 className="text-[#4a1e75] font-Jost md:text-[36px] text-[25px]">MBBS IN INDIA</h3>
...
<Link href={'/mbbs'} className="text-[#4a1e75] text-[15px] font-Poppins font-[500] underline">Learn More</Link>
      </div>
