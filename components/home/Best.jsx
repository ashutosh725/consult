...
const Best = () => {
  ...
  <div className="bg-white flex flex-col justify-center items-center gap-3 rounded-lg p-6 shadow-md">
    ...
    <h2 className="text-[30px] font-bold">6+
</h2>
    <p className="text-gray-600 text-[16px] tracking-wide font-medium">Career Counsellors

</p>
  </div>
  <div className="bg-white flex flex-col justify-center items-center gap-3 rounded-lg p-6 shadow-md">
    <Image src={'/year-of-experience.png'} width={50} height={50} objectFit='cover'/>
    <h2 className="text-[30px] font-bold">8+

</h2>
    <p className="text-gray-600 text-[16px] tracking-wide font-medium">Years Of Experience
  ...
  <div className="bg-white flex flex-col justify-center items-center gap-3 rounded-lg p-6 shadow-md">
    ...
    <h2 className="text-[30px] font-bold">250+

</h2>
    <p className="text-gray-600 text-[16px] tracking-wide font-medium">Enrolments

</p>
  </div>
  <div className="bg-white flex flex-col justify-center items-center gap-3 rounded-lg p-6 shadow-md">
    <Image src={'/testimonials.png'} width={50} height={50} objectFit='cover'/>
    <h2 className="text-[30px] font-bold">600+

</h2>
    <p className="text-gray-600 text-[16px] tracking-wide font-medium"> Testimonials
...
<li className='flex justify-start items-center gap-4'><Image src={'/Icon-awesome-graduation-cap.png'} width={40} height={40} objectFit='cover'/> <p className='text-[14px] font-medium'>With over 8 years of experience we provide the best educational solutions.
            ...
            <button className='bg-[#000000] rounded-full tracking-wide px-6 py-3 text-white text-[16px] font-medium mt-10'>Know More</button>
          </div>
        </div>
      </div>
    </div>
