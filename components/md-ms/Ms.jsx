...
import Www from '../../public/telehealth-38.png'
...
const Ms = () => {
  return (
    ...
    <div className='container mx-auto'>
        <h3 className='text-center lg:text-[45px] text-[20px] font-bold text-[#333333]'>Adavantages of MD/MS Courses</h3>
                ...
                <div className='flex gap-3'>
                   ...
                   <div>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className='text-[14px] tracking-wide'>MD/MS courses provide in-depth knowledge and specialized expertise in specific medical disciplines, allowing healthcare professionals to become experts in their chosen field.</p>
                    </div>
                </div>
                <div className='flex gap-3'>
                <div>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className='text-[14px] tracking-wide'>MD/MS qualifications open up new career opportunities and improve prospects for career advancement, including access to higher-level positions, leadership roles, and academic positions.</p>
                    </div>
                </div>
                <div className='flex gap-3'>
                <div>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className='text-[14px] tracking-wide'>Completion of MD/MS courses enhances professional credibility and provides recognized credentials that are valued by employers, institutions, and the medical community.</p>
                    </div>
                </div>
                <div className='flex gap-3'>
                <div>
